...
public class Version implements Comparable<Version> {
	...
	public void sendToLog(Helper.LogType logType, String logMessage) {
		...
		if (logType.equals(Helper.LogType.WARN)) getLogger().warn(getLoggerPrefix() + logMessage);
		if (logType.equals(Helper.LogType.ERROR)) getLogger().error(getLoggerPrefix() + logMessage);
		if (logType.equals(Helper.LogType.DEBUG)) getLogger().debug(getLoggerPrefix() + logMessage);
	}
}